...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
          ...
          ['Category', 'Expense'],
           <?php
            foreach ($chartDonut as $corechart) {
              echo "['".strval($corechart['category'])."',".$corechart['expense']."],";
            }
        ...
        var options = {
          title: 'Categorical Expense:2020',
          is3D: true,
        };
...
<div class="container">
  ...
  <?php echo validation_errors(); ?>
    <?php echo form_open('Expense/insertExpense'); ?>
	...
	<div class="form-group">
	    <div class="input-group">
	      ...
	      <div class="input-group-addon">.00</div>
		    ...
		    <select name="expense" class="form-control form-control-lg" id="expense">
...
<div class="container">
   <div id="piechart_3d" style="padding: 50px; position: absolute; width: 700px; height: 400px; left: 600px; top: 20px;"></div>
</div>
